...
namespace SisfacoDeskApp.Presentation_Layer.Business_Forms
{
    public partial class Country : Form
    {
        ...
        public Country()
        {
            ...
            this.ttmessage.SetToolTip(this.countrytxt, "Ingresar el Nombre del Pais");
            this.ttmessage.SetToolTip(this.postalcodetxt, "Ingrese el codigo Postal");
        }
        ...
        private void savebtn_Click(object sender, EventArgs e)
        {
            if (codetxt.Text == "0")
            {
                if (countrytxt.Text == "" || postalcodetxt.Text == "")
                {
                    Presentation_Layer.Alerts.AlertMessage.Show("No se permiten campos vacios", Alerts.AlertMessage.AlertType.error);
                }
                else
                {
                    linq.Insert_Pais(countrytxt.Text.Trim(), int.Parse(postalcodetxt.Text.Trim()));
            ...
            else
            {
                ...
                {
                    linq.Update_Pais(int.Parse(codetxt.Text.Trim()), countrytxt.Text.Trim(), int.Parse(postalcodetxt.Text.Trim()));
        ...
        {
            Country_Query c = new Country_Query();
            AddOwnedForm(c);
            c.Show();
        }
        ...
        {
            codegried.DataSource = linq.Query_Code_Pais();
        ...
        private void postalcodetxt_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            else if ((e.KeyChar == '+') && (!postalcodetxt.Text.Contains("+")))
            {
                e.Handled = false;
            }
            else
