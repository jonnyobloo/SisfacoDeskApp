...
namespace SisfacoDeskApp.Presentation_Layer.Business_Forms
{
    public partial class Province_Query : Form
    {
        ...
        {
            querygrid.DataSource = linq.DinamicQuery_Provincia(searchtxt.Text);
        ...
        {
            Province p = Owner as Province;
            p.codetxt.Text = Convert.ToString(code);
            p.provincetxt.Text = province;
            this.Close();
        }
        ...
        private void querygrid_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            province = querygrid[2, pos].Value.ToString();
        }

        private void Province_Query_Load(object sender, EventArgs e)
        {
            grieddata();
            registrylbl.Text = Convert.ToString(querygrid.Rows.Count);
        }
        ...
        {
            querygrid.DataSource = linq.Query_Provincia();
        }
    }
}
