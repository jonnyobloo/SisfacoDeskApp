...
{
    public partial class Brand_Query : Form
    {
        ...
        {
            querygrid.DataSource = linq.DinamicQuery_Marca(searchtxt.Text);
            registrylbl.Text = Convert.ToString(querygrid.Rows.Count);
        }

        private void sendbtn_Click(object sender, EventArgs e)
        {
            Brand b = Owner as Brand;
            b.codetxt.Text = Convert.ToString(code);
            b.areanametxt.Text = areaname;
            b.observationtxt.Text = observations;
            this.Close();
        }
        ...
        private void querygrid_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            observations = querygrid[2, pos].Value.ToString();
        }
        ...
        {
            querygrid.DataSource = linq.Query_Marca();
        }

        private void Brand_Query_Load(object sender, EventArgs e)
        {
            grieddata();
            registrylbl.Text = Convert.ToString(querygrid.Rows.Count);
        }
